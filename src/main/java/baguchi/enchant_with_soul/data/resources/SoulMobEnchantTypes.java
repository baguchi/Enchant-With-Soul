...
public class SoulMobEnchantTypes {
    ...
    private static ResourceKey<MobEnchantType> createKey(String name) {
        return ResourceKey.create(MobEnchantTypes.MOB_ENCHANT_TYPE_REGISTRY_KEY, ResourceLocation.fromNamespaceAndPath(EnchantWithSoul.MODID, name));
    }

    public static void bootstrap(BootstrapContext<MobEnchantType> context) {

        context.register(SOUL, new MobEnchantType(
                ResourceLocation.fromNamespaceAndPath(EnchantWithSoul.MODID, "textures/entity/soul_layer.png"),
                1.5F,
